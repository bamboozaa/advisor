@extends('layouts.app')
@section('title', 'ข้อมูลหลักสูตร/คณะ')
    ...
    <div class="container-fluid">
            ...
            <div class="col-md-9">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ __('Faculties') }}</li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="row justify-content-end">
            <div class="card bg-white">
                <div class="card-header mt-1"><i class="bi bi-border-all fs-6 me-2"></i>{{ __('ข้อมูลหลักสูตร/คณะ') }}</div>
                <div class="card-body">
                        ...
                        <table class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" class="text-nowrap">{{ __('ชื่อหลักสูตร/คณะ') }}</th>
