            ...
            <div class="col-md-9">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ __('Edit Major') }}</li>
                    </ol>
                </nav>
            </div>
            <div class="col-md-3" style="text-align: right!important;">
                <a href="{{ url('majors') }}" class="btn btn-primary mb-2"><i class="bi bi-back fs-sm me-2"></i>{{ __('Back') }}</a>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card bg-white">
                    <div class="card-header">{{ __('Edit Major') }}</div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('majors.update', $major->id) }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="major_name" class="form-control" value="{{ old('name', $major->major_name) }}" />
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-auto">
                                    {!! Form::select('fac_id', $faculties, old('name', $major->faculty['id']), [
                                    'class' => 'form-select',
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-auto">
                                    <input type="text" name="major_year" class="form-control" value="{{ old('name', $major->major_year) }}" />
                                </div>
                            </div>
