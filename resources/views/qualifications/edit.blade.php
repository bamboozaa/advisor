                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('qualifications.update', old('name', $qualification->id)) }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-auto">
                                    <input type="text" name="thesis" class="form-control" value="{{ old('name', $qualification->thesis) }}" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="is" class="col-sm-3 col-form-label text-end">{{ __('จำนวนการค้นคว้าอิสระ (IS) :') }}</label>
                                <div class="col-sm-auto">
                                    <input type="text" name="is" class="form-control" value="{{ old('name', $qualification->is) }}" />
                                </div>
                            </div>
