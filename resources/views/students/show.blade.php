                        ...
                        <table class="table table-hover table-sm">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {!! Form::select('academic_year', ["" => 'Select Year'], old('name', $student->academic_year), ['class' => 'form-select form-select-sm w-auto', 'id' => 'year', 'disabled', 'data-my-data' => $student->academic_year]) !!}
                                    </td>
